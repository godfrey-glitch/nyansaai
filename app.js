...
const BANK={
  ...
  coding:{beginner:[{question:"HTML stands for?",options:["Hyper Text Markup Language","High Tech Modern Language","Hyper Transfer Markup Logic","Home Tool Markup Language"],answer:0,hint:"Used to create web pages.",explanation:"HTML = HyperText Markup Language."},{question:"Output of print(2 + 3 * 4) in Python?",options:["20","14","24","10"],answer:1,hint:"BODMAS: multiplication before addition.",explanation:"3×4=12, then 2+12=14."}]},
...
async function _prefetch(sub,lvl,mode){
  ...
  var p=isW?'Generate a '+lvl+' '+sub+' short-answer question for a Ghanaian student. Return ONLY JSON: {"question":"...","sampleAnswer":"...","hint":"...","explanation":"..."}'
    :'Generate a unique '+lvl+' '+sub+' multiple choice question for a Ghanaian student. Return ONLY JSON: {"question":"...","options":["a","b","c","d"],"answer":0,"hint":"...","explanation":"..."}. answer is 0-3.';
